...
import Rio from '../../img/imoveis/favicon.png';
      ...
      {isLoading ? (
        ...
        <>
          <h1 className={styles.h1}>
            <span className={styles.span}>Bem-vindo à Rio Imóveis</span>
          </h1>
          ...
          &nbsp; &nbsp; Nossa equipe de profissionais está habilitada a prestar a melhor assessoria no que for necessário para auxilia-lo nesse momento.
            ...
            <div className={styles.homeFooter}>
              <h1 className={styles.titleVenda}> <MdAttachMoney/> Deseja vender seu Imóvel?  <MdAttachMoney/> </h1>
              <p>Apenas com um clique, você é capaz de anunciar seu Imóvel na maior imobiliária	do Brasil!!! </p>
